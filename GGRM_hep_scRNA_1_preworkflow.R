...
# 获取目录列表 - 查找所有样本文件夹
dir_name <- list.files('/home/lin/GGRM_hep/hepatocellular_scRNA_seq/')
print("发现的样本目录:")
print(dir_name)
...
for(i in 1:length(dir_name)){
  ...
  counts <- Read10X(data.dir = file.path("/home/lin/GGRM_hep/hepatocellular_scRNA_seq/", dir_name[i]))
...
write.csv(qc_summary, paste0("/home/lin/GGRM_hep/result/QC_summary_", SPECIES, "_", Sys.Date(), ".csv"), row.names = FALSE)
cat(paste0("\n质控统计已保存至: /home/lin/GGRM_hep/result/QC_summary_", SPECIES, "_", Sys.Date(), ".csv\n"))
...
# 保存RDS文件
saveRDS(scRNAlist_merge, file = "/home/lin/GGRM_hep/result/GGRM_hep_scRNAseq_11m26d.rds")